	...
	return (
		<div className='flares w-full h-full'>
			<img
				...
				alt=''
				className='flares-top w-full h-full blur-3xl'
			/>
			<img
				...
				alt=''
				className='new-flare-nav top-right hide-mobile w-full h-full blur-3xl'
			/>
			<img
				...
				alt=''
				className='new-flare-nav top-left hide-mobile w-full h-full blur-3xl'
			/>
		</div>
	)
}
