export const Background = () => (
	<>
		...
		<svg
			aria-hidden='true'
			className='pointer-events-none w-full absolute inset-0 fill-green-light/[.06] stroke-green-light/[.06] dark:fill-white/[.06] dark:stroke-white/[.06] [mask-image:linear-gradient(to_bottom_right,white,transparent,transparent)] inset-x-0 -top-[1rem] -z-50 h-[80%] skew-y-12'
		>
			<defs>
