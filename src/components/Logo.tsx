...
export function Logo() {
	return (
		...
		>
			<span className='text-transparent hover:text-[#ffa600ab] hover:[-webkit-text-stroke-width:2px] duration-500 transition-colors relative bottom-[2px] [-webkit-text-stroke-width:4px] [-webkit-text-stroke-color:#D4D4D8]'>
				solid
			</span>
			Snk86
		</h1>
