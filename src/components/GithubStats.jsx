	...
	return (
		<div className='inline-flex items-center space-x-2'>
			...
			<a
				...
				target='_blank'
			>
				<span className='text-sm md:text-base font-medium'>{data.stars}</span> <span>stars</span>
			</a>
		</div>
	)
}
