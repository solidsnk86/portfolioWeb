	...
	resources: {
		en: {
			translation: {
				...
				phoneForm: 'Phone only support numbers',
				emailForm: 'Invalid email',
				subjectForm: 'Subject is required',
				messageForm: 'Message must be at least 50 characters',
				messageForm1: 'Message must be at maximun 160 characters',
				send: 'Send',
				sending: 'Sending...',
		...
		es: {
			translation: {
				...
				exp: 'año',
				exps: 'años',
				welcome: 'Hola, bienvenid@! Me alegra recibirte desde',
				...
				contact: 'Contacto',
				nameForm: 'Nombre es requerido',
				phoneForm: 'Teléfono sólo soporta números',
				emailForm: 'Correo inválido',
				subjectForm: 'Asunto requerido',
				messageForm: 'El mensaje debe tener al menos 50 caracteres',
				messageForm1: 'El mensaje debe tener como máximo 160 caracteres',
				send: 'Enviar',
				sending: 'Enviando...',
