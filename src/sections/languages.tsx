...
const Lang = [
	...
	},
	{
		...
		logo: (
			<div
				className={
					' translate-x-[-133px] relative w-fit flex justify-center items-center px-1 py-1 overflow-hidden rounded-lg border transition bg-zinc-800/95 border-zinc-600/75 hover:shadow-lg'
				}
			>
				<svg
					role='img'
	...
	},
	{
		...
		logo: (
			<div
				className={
					' translate-x-[92px] relative w-fit flex justify-center items-center px-1 py-1 overflow-hidden rounded-lg border transition bg-zinc-800/95 border-zinc-600/75 hover:shadow-lg'
				}
			>
				<svg
					role='img'
	...
	},
	{
		...
		logo: (
			<div
				className={
					' translate-x-[-76px] relative w-fit flex justify-center items-center px-1 py-1 overflow-hidden rounded-lg border transition bg-zinc-800/95 border-zinc-600/75 hover:shadow-lg'
				}
			>
				<svg
					role='img'
	...
	},
	{
		...
		logo: (
			<div
				className={
					'translate-y-[32px] relative w-fit flex justify-center items-center px-1 py-1 overflow-hidden rounded-lg border transition bg-zinc-800/95 border-zinc-600/75 hover:shadow-lg'
				}
			>
				<svg
					role='img'
	...
	},
	{
		...
		logo: (
			<div
				className={
					'group-hover:scale-110 translate-x-[96px] relative w-fit flex justify-center items-center px-1 py-1 overflow-hidden rounded-lg border transition bg-zinc-800/95 border-zinc-600/75 hover:shadow-lg'
				}
			>
				<svg
					role='img'
